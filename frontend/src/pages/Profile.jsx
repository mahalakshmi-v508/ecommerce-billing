    ...
    <div className="min-h-screen bg-white py-8 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-8 text-center">
          <div className="inline-flex items-center gap-3 bg-white rounded-full px-6 py-3 shadow-lg mb-4 border border-green-100">
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
              <div className="bg-gradient-to-r from-green-600 to-emerald-500 p-6 text-center">
                ...
                <p className="text-green-100 text-sm mt-1">{user?.role || 'Customer'}</p>
              </div>
              ...
              <div className="p-6 space-y-4">
                ...
                <div className="pt-4 border-t border-gray-100">
                  <div className="flex justify-between text-center">
                    ...
                    <div>
                      <p className="text-2xl font-bold text-green-600">{reviewCount}</p>
              ...
              <div className="space-y-6">
                ...
                <div className="bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl p-4">
                  <label className="block text-xs font-semibold text-gray-500 uppercase mb-2">
                    <Fingerprint className="w-3 h-3 inline mr-1 text-green-600" />
                    User ID
                  </label>
